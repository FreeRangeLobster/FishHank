...
Display::Display(int pin)
{
  ...
  _pin = pin;
    ...
    void Display::ShowStatus(char sStatus[10]){}         
    const char* Display::ShowTemperature(){}
    const char* Display::ShowOutputs(){}
    const char* Display::ShowTime(){}
    const char* Display::InitialDisplayShow(){}
